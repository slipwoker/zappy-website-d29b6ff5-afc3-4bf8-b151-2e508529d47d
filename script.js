    ...
    if (contactForm) {
        ...
        contactForm.addEventListener('submit', function(e) {
            ...
            formInputs.forEach(input => {
                ...
                const validator = validators[input.name] || validators[input.type];
                if (validator) {
...
(function() {
    ...
    contactForm.addEventListener('submit', async function(e) {
        ...
        try {
            ...
            var payload = {
                websiteId: 'd29b6ff5-afc3-4bf8-b151-2e508529d47d',
                name: resolvedName,
                email: resolvedEmail,
            ...
            if (result.success) {
                ...
                if (result.thankYouPagePath && result.ticketNumber) {
                    ...
                    if (isPreview && window.ZAPPY_CONFIG) {
                        var wid = window.ZAPPY_CONFIG.websiteId || 'd29b6ff5-afc3-4bf8-b151-2e508529d47d';
...
(function(){
  try {
    ...
    document.addEventListener('submit', function(e) {
      ...
      var wid = 'd29b6ff5-afc3-4bf8-b151-2e508529d47d';
